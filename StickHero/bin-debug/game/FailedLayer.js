...
var FailedLayer = (function (_super) {
    ...
    FailedLayer.prototype.initView = function () {
    ...
    //分享按钮回调
    FailedLayer.prototype.shareBtnCallback = function (e) {
        this.addChild(this.shareTips);
    };
    //home按钮回调
    FailedLayer.prototype.homeBtnCallback = function (e) {
        Director.getInstance().runScene(new StartScene());
    };
    //restart按钮回调
    FailedLayer.prototype.restartBtnCallback = function (e) {
        Director.getInstance().runScene(new GameScene());
    };
    //moreGame回调
    FailedLayer.prototype.moreGameCallback = function (e) {
